...
```
https://1d1d437b-848e-4517-a982-97433efdc820.preview.emergentagent.com/flights/results?origin=PNQ&destination=BOM&departure_date=2025-12-07&adults=1&cabin_class=economy
```
...
# OR via preview URL:
https://1d1d437b-848e-4517-a982-97433efdc820.preview.emergentagent.com/api/docs
```
...
**1. Test Autocomplete:**
- Open: https://1d1d437b-848e-4517-a982-97433efdc820.preview.emergentagent.com
...
┌─────────────────────────────────────────────────────────┐
│  Browser (User)                                         │
│  https://[preview-url].preview.emergentagent.com        │
└──────────────────────┬──────────────────────────────────┘
                       │
                       │ HTTPS
                       ▼
