            ...
            for dest_code in destination_airports:
                ...
                if self.flight_provider == "amadeus":
                    ...
                    if circuit_breaker.is_available("duffel"):
                        ...
                        logger.warning("⚠️ Duffel circuit breaker OPEN - will use Kiwi fallback")
                    ...
                    if circuit_breaker.is_available("duffel"):
                        ...
                        logger.warning("⚠️ Duffel circuit breaker OPEN - will use Kiwi if needed")
                else:
                ...
                # Add Kiwi.com as fallback if all primary suppliers are unavailable
                if not primary_added and kiwi_adapter.enabled:
                    logger.info("🥝 Using Kiwi.com as fallback (all primary suppliers unavailable)")
