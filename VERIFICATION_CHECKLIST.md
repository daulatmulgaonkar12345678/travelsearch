...
- [x] `.env.local` updated with remote URL: `https://travel-api-shield.preview.emergentagent.com`
...
- Console logs show: `[API] GET https://travel-api-shield.preview.emergentagent.com/api/...`
...
2. **Network Tab:** 
   ...
   - All should start with `https://travel-api-shield.preview.emergentagent.com`
3. **Console Tab:**
...
2. Test backend directly: `curl https://travel-api-shield.preview.emergentagent.com/api/health`
...
**ALL of these should use:** `https://travel-api-shield.preview.emergentagent.com`
