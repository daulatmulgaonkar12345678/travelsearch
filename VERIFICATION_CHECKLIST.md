...
- [x] `.env.local` updated with remote URL: `https://busway-planner.preview.emergentagent.com`
...
- Console logs show: `[API] GET https://busway-planner.preview.emergentagent.com/api/...`
...
2. **Network Tab:** 
   ...
   - All should start with `https://busway-planner.preview.emergentagent.com`
3. **Console Tab:**
...
2. Test backend directly: `curl https://busway-planner.preview.emergentagent.com/api/health`
...
**ALL of these should use:** `https://busway-planner.preview.emergentagent.com`
