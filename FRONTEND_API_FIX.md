...
```bash
NEXT_PUBLIC_API_BASE_URL=https://travel-api-shield.preview.emergentagent.com
```
...
```bash
curl "https://travel-api-shield.preview.emergentagent.com/api/airports?query=pu&limit=10"
...
**Expected Behavior:**
1. User navigates to: `https://travel-api-shield.preview.emergentagent.com/`
2. Types "pu" in the From field
3. DevTools Network tab shows request to:
   ```
   https://travel-api-shield.preview.emergentagent.com/api/airports?query=pu&limit=10
   ```
...
### Mumbai Test
```bash
curl "https://travel-api-shield.preview.emergentagent.com/api/airports?query=mum&limit=10"
...
curl "https://travel-api-shield.preview.emergentagent.com/api/airports?query=pu"
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://travel-api-shield.preview.emergentagent.com"],
...
**Flight Search API:**
```
https://travel-api-shield.preview.emergentagent.com/api/search/flights?origin=PNQ&destination=BOM&departure_date=2025-12-07&adults=1
```
...
# Test backend API
curl "https://travel-api-shield.preview.emergentagent.com/api/health"
```
