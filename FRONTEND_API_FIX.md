...
```bash
NEXT_PUBLIC_API_BASE_URL=https://flighthotelcompare.preview.emergentagent.com
```
...
```bash
curl "https://flighthotelcompare.preview.emergentagent.com/api/airports?query=pu&limit=10"
...
**Expected Behavior:**
1. User navigates to: `https://flighthotelcompare.preview.emergentagent.com/`
2. Types "pu" in the From field
3. DevTools Network tab shows request to:
   ```
   https://flighthotelcompare.preview.emergentagent.com/api/airports?query=pu&limit=10
   ```
...
### Mumbai Test
```bash
curl "https://flighthotelcompare.preview.emergentagent.com/api/airports?query=mum&limit=10"
...
1. **`.env.local`**
   ```diff
   - NEXT_PUBLIC_API_URL=https://1d1d437b-848e-4517-a982-97433efdc820.preview.emergentagent.com
   + NEXT_PUBLIC_API_BASE_URL=https://flighthotelcompare.preview.emergentagent.com
   ```
...
curl "https://flighthotelcompare.preview.emergentagent.com/api/airports?query=pu"
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://flighthotelcompare.preview.emergentagent.com"],
...
**Homepage:**
```
https://flighthotelcompare.preview.emergentagent.com/
```
...
**Flight Search API:**
```
https://flighthotelcompare.preview.emergentagent.com/api/search/flights?origin=PNQ&destination=BOM&departure_date=2025-12-07&adults=1
```

**API Documentation:**
```
https://flighthotelcompare.preview.emergentagent.com/api/docs
```
...
# Test backend API
curl "https://flighthotelcompare.preview.emergentagent.com/api/health"
```
